...
public class Scene02 : Scene
{
    ...
    {
        var abs01EndScale = _abs01StartScale - new Vector3(0.003f, 0.003f, 0.003f);
        ...
        var abs02EndScale = _abs02StartScale - new Vector3(0.003f, 0.003f, 0.003f);
